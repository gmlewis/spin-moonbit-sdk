...
This example builds against the SDK in this repository (rather than against a
published release), which `moon` expresses with the `moon.work` workspace file
next to this README. It is what makes `moon build` pick up local SDK edits.
